...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.42\textwidth]{figuras/ina122_estructura.png}
    \caption{Conexiones básicas y estructura interna del INA122, incluidos los terminales para la
    resistencia externa $R_g$. En este diseño no se conecta $R_g$, por lo que la ganancia nominal es
    5. Adaptado de Texas Instruments, p. 1 \cite{ti_ina122}.}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[page=8,trim=68 520 323 121,clip,width=0.62\textwidth]{INA122_datasheet.pdf}
    ...
    Texas Instruments, p. 8 \cite{ti_ina122}.}
...
Permite obtener una señal del orden de 1,78~V pico a pico antes del detector a partir del
...
\begin{table}[htbp]
    ...
    \begin{tabular}{lr}
        ...
        Salida del primer filtro inversor & 141 \\
        Salida del pasaaltos activo & 477 \\
        Salida del segundo seguidor & 391 \\
        Salida del amplificador final, antes del detector & 1779 \\
        \hline
    \end{tabular}
\end{table}
La salida final prevista de 1,78~V pico a pico corresponde a una amplitud de aproximadamente
0,89~V de pico para una senoide. En la sección de resultados se comparará esta estimación con la señal medida en el prototipo.
...
antes del detector (1450~mV) es un 18\,\% menor que la prevista (1779~mV). La ganancia medida desde la
salida del INA hasta ese punto es aproximadamente 104, frente a 127 en el cálculo ideal. La
...
\begin{table}[htbp]
    ...
    \begin{tabular}{lrr}
        ...
        Primer filtro inversor & 1,01 & 1,01 \\
        Pasaaltos activo & 3,37 & 3,19 \\
        Pasabajos y seguidor & 0,821 & 0,647 \\
        Amplificador final & 4,55 & 4,39 \\
        Total desde la salida del INA & 127 & 104 \\
        \hline
    \end{tabular}
\end{table}

La mayor parte de la diferencia se concentra en el pasabajos. Una ganancia de 0,647 a 50~kHz equivale a
